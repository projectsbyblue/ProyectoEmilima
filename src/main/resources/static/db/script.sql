/*drop database db_emilima;*/
create schema db_emilima;
...
(
    ...
    perPrueba int not null,
    horaIng varchar(10) not null,
    horaSal varchar(10) not null,
    remuneracion double not null,
    fechaReg timestamp default CURRENT_TIMESTAMP,
    contratoPdf varchar(300) null,
    estado varchar(20) default('NO-VF'),
...
delimiter @@
create procedure usp_registrar_contrato(idContrato char(5), idTrabajador char(5), tipo varchar(30), motivo varchar(300), 
										temporada int,idCargo char(3), FecInicio date, perPrueba int,
                                        horaIng varchar(10), horaSal varchar(10), remuneracion double)
begin
	insert into contratos(idContrato, idTrabajador, tipo, motivo, temporada, idCargo, FecInicio,perPrueba,horaIng,horaSal,remuneracion)
    values (idContrato, idTrabajador, tipo, motivo, temporada, idCargo, FecInicio,perPrueba,horaIng,horaSal,remuneracion);
end @@
delimiter ;

drop procedure if exists usp_actualizar_trabajador;
delimiter @@
create procedure usp_actualizar_trabajador(id char(5), nom varchar(50), 
ape varchar(50), dir varchar(300), ciudad int, provincia int, distrito int)
begin
	update trabajadores set nombres = nom, apellidos = ape, direccion = dir,
    idCiudad = ciudad, idProvincia = provincia, idDistrito = distrito
...
('mike@emilima.com','root'),
('james@emilima.com','root');


insert into perfiles values
(1,'Mike','Wazowski','87654321','./img/display.png','Especialista ORH','mike@emilima.com'),
(2,'James','Sullivan','88656322','./img/display.png','Especialista ORH','james@emilima.com');

insert into trabajadores values
('T0001','78152431','Andres Javier','Peres Gusman','Calle Javier Prado 201',1,1,1),
('T0002','04458230','Daviv Nicolas','Florez Toledo','Calle Domingo Nieto 320',1,1,1),
('T0003','04850512','Maria Claudia','Rivera Torres','Av. Arequipa 100',1,1,1);

insert into cargos values
('C01','Ing. Sistemas'),
('C02','Gerente Financiero'),
('C03','Gerente Comercial');

insert into contratos(idContrato, idTrabajador, tipo, motivo, temporada, idCargo, FecInicio,perPrueba,horaIng,horaSal,remuneracion)
values 
('C0001', 'T0001', 'asignacion', 'Motivo de contrato', 8, 'C01', '2121-10-10',3,'8:am','5:00 pm',3500),
('C0002', 'T0002', 'asignacion', 'Motivo de contrato', 12, 'C01', '2121-10-10',3,'8:am','5:00 pm',3500),
('C0003', 'T0003', 'asignacion', 'Motivo de contrato', 24, 'C01', '2121-10-10',3,'8:am','5:00 pm',3500);
